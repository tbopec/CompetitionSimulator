...
namespace AIRLab.Mathematics {
    ...
    public struct Circle2D {
        ...
        //TODO спросить у юры почему нужно писать именно так?!
    ...
    public struct Sector
    {
        ...
        {
            var startAngle = Angem.GetAbsAngle(Start ,Circle.Center);
			var finalAngle = Angem.GetAbsAngle(Finish ,Circle.Center);
