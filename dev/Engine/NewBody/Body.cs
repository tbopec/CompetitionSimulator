...
namespace Eurosim.Core
{
		...
		IVisitable<IBodyVisitor>
	{
        ...
        public Dictionary<string, object> getEditJSON()
        {
            Dictionary<string, object> result = new Dictionary<string, object>();

            result.Add("id", _id);
            result.Add("parent", _parent.Id);

            result.Add("x", _location.X);
            result.Add("y", _location.Y);
            result.Add("z", _location.Z);

            result.Add("pitch", _location.Pitch.Radian);
            result.Add("roll", _location.Roll.Radian);
            result.Add("yaw", _location.Yaw.Radian);

            return result;
        }

        public virtual Dictionary<string, object> getCreateJSON()
        {
