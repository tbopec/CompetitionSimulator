...
namespace Eurosim.Core.Physics.FarseerWrap
{
	static public class FarseerConverter
	{
		...
		static public BEPUphysics.MathExtensions.Vector3 Frame3DToVector3(Frame3D frame)
		{
			return new BEPUphysics.MathExtensions.Vector3((float)frame.X, (float)frame.Y, (float)frame.Z);
		}
